...
class TestContactsControllerIntegration:
    ...
    def test_get_contacts_empty(self, client, mock_contacts_service):
        ...
        # Arrange
        mock_contacts_service.return_value.get_contacts.return_value = []
    ...
    def test_get_contacts_default_pagination(self, client, mock_contacts_service):
        """Test contacts retrieval with default pagination parameters."""
        # Arrange
        mock_contacts_service.return_value.get_contacts.return_value = []
    ...
    def test_search_contacts_by_last_name(
        ...
        # Act
        response = client.get("/api/contacts/search?last_name=Doe")
    ...
    def test_search_contacts_by_email(
        ...
        # Act
        response = client.get("/api/contacts/search?email=test@example.com")
    ...
    def test_delete_contact_success(self, client, mock_contacts_service):
        ...
        # Arrange
        mock_contacts_service.return_value.delete_contact.return_value = True
    ...
    def test_reset_password_success(self, client, mock_contacts_service):
        ...
        # Arrange
        mock_contacts_service.return_value.reset_password.return_value = None
